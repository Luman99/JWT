...
const CreateExamPage = () => {
  ...
  let getStudentsGroups = async()=>{
    let response = await fetch('http://ec2-18-159-196-177.eu-central-1.compute.amazonaws.com:8000/api/students_group/', {
      method:'GET',
      headers:{
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get('http://ec2-18-159-196-177.eu-central-1.compute.amazonaws.com:8000/api/questions/1/',
        {
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer ' + String(authTokens.access),
  ...
  const handleCreateExam = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://ec2-18-159-196-177.eu-central-1.compute.amazonaws.com:8000/api/create_exam/', 
      {
        name,
        description,
        start,
      ...
      await axios.patch(`http://ec2-18-159-196-177.eu-central-1.compute.amazonaws.com:8000/api/exams/${examId}/add_questions/`, 
      {
      ...
      await axios.patch(`http://ec2-18-159-196-177.eu-central-1.compute.amazonaws.com:8000/api/exams/${examId}/users/`, 
      {
